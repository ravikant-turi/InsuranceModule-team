...
<h:form id="companyForm">
		...
		<h:inputText id="companyId" value="#{insurancePlanController.insurancePlan.insuranceCompany.companyId}" />
		<h:message for="companyId" style="color:red" />
		<br />
		<br />

		<h:outputText value="Enter the Plan Name: " />
		<h:inputText id="planName" value="#{insurancePlanController.insurancePlan.planName}" />
		<h:message for="planName" style="color:red" />
		<br />
		<br />

		<h:outputText value="Select Plan Type: " />
<h:selectOneMenu id="planType" value="#{insurancePlanController.insurancePlan.planType}">
...
<h:message for="planType" style="color:red" />
		...
		<h:inputText id="minAge" value="#{insurancePlanController.insurancePlan.minEntryAge}" />
		<h:message for="minAge" style="color:red" />
		<br />
		<br />

		<h:outputText value="Max Entry Age: " />
		<h:inputText id="maxAge" value="#{insurancePlanController.insurancePlan.maxEntryAge}" />
		<h:message for="maxAge" style="color:red" />
		<br />
		<br />

		<h:outputText value="Description: " />
		<h:inputTextarea id="description" value="#{insurancePlanController.insurancePlan.description}"
			rows="3" cols="30" />
		...
		<h:inputText id="cover" value="#{insurancePlanController.insurancePlan.availableCoverAmounts}" />
		<h:message for="cover" style="color:red" />
		<br />
		<br />

		<h:outputText value="Waiting Period: " />
		<h:inputText id="waitingPeriod" value="#{insurancePlanController.insurancePlan.waitingPeriod}" />
		<h:message for="waitingPeriod" style="color:red" />
		<br />
		<br />

		<h:outputText value="Active On (yyyy-MM-dd): " />
		<h:inputText id="activeOn" value="#{insurancePlanController.insurancePlan.activeOn}">
